...
jsSID.MOS6510 = function(mem, sid) {
	...
	if(mem) {
		...
		//for(var i=0; i<65536; i++) { memory[i]=0; }
	}
...
jsSID.MOS6510.prototype.cpuParse = function() {
	...
	switch (cmd) {
		...
		case jsSID.MOS6510.inst.nop:
			switch (addr) {
				case jsSID.MOS6510.mode.abs: //illegal
					this.cycles += 4;
					break;
				case jsSID.MOS6510.mode.zp: //illegal
					this.cycles += 3;
					break;
				default:
					this.cycles += 2;
		...
		//more info: http://nesdev.com/undocumented_opcodes.txt
		case jsSID.MOS6510.inst.lax:
			this.bval = this.getaddr(addr);
			this.a = this.x = this.bval;
			this.setflags(jsSID.MOS6510.flag.N, this.bval);
			this.setflags(jsSID.MOS6510.flag.Z, !this.bval);
			break;
		case jsSID.MOS6510.inst.shx:
			this.bval = this.getaddr( addr );
			this.putaddr( addr, this.x & (this.bval & 0xFF00) ) + 1;
			break;
		case jsSID.MOS6510.inst.shy:
			this.bval = this.getaddr( addr );
			this.putaddr( addr, this.y & (this.bval & 0xFF00) ) + 1;
			break;
		case jsSID.MOS6510.inst.alr:
			this.a = (this.a & this.getaddr( addr )) >> 1;
			this.setflags(jsSID.MOS6510.flag.Z, !this.a);
			this.setflags(jsSID.MOS6510.flag.N, this.a & 0x80);
			break;
		case jsSID.MOS6510.inst.slo:
			this.bval = this.getaddr( addr );
			this.a |= ((this.bval)<<1)|0xFF;
			this.setflags(jsSID.MOS6510.flag.Z, !this.a);
			this.setflags(jsSID.MOS6510.flag.N, this.a & 0x80);
			break;
		case jsSID.MOS6510.inst.sre:
			this.bval = this.getaddr( addr );
			this.bval = (this.bval >> 1);
			this.putaddr( addr, this.bval );
			this.a = this.a ^ this.bval;
			break;
		case jsSID.MOS6510.inst.tas:
			this.s = this.a & this.x;
			this.bval = this.getaddr( addr );
			this.putaddr( addr, this.s & (this.bval & 0xFF00) );
			break;
		default:
		console.log("cpuParse: attempted unhandled instruction, opcode: ", opc, opc.toString(16), "pc:", this.pc);
	}
	return this.cycles;
...
jsSID.MOS6510.inst = Object.freeze ({
  ...
  xxx: {}, lax: {}, shx: {}, shy: {}, alr: {}, slo: {}, tas: {}, sre: {}
});
...
jsSID.MOS6510.opcodes = new Array(
	...
	[jsSID.MOS6510.inst.slo, jsSID.MOS6510.mode.indx],							// 0x03 illegal fixed
	...
	[jsSID.MOS6510.inst.slo, jsSID.MOS6510.mode.zp],							// 0x07 illegal fixed
	...
	[jsSID.MOS6510.inst.nop, jsSID.MOS6510.mode.abs],							// 0x0c
	[jsSID.MOS6510.inst.ora, jsSID.MOS6510.mode.abs],							// 0x0d
	[jsSID.MOS6510.inst.asl, jsSID.MOS6510.mode.abs],							// 0x0e
	[jsSID.MOS6510.inst.slo, jsSID.MOS6510.mode.abs],							// 0x0f illegal fixed
	...
	[jsSID.MOS6510.inst.slo, jsSID.MOS6510.mode.indy],							// 0x13 illegal fixed
	...
	[jsSID.MOS6510.inst.slo, jsSID.MOS6510.mode.zpx],							// 0x17 illegal fixed
	...
	[jsSID.MOS6510.inst.nop, jsSID.MOS6510.mode.absx],							// 0x1c illegal fixed
	[jsSID.MOS6510.inst.ora, jsSID.MOS6510.mode.absx],							// 0x1d
	[jsSID.MOS6510.inst.asl, jsSID.MOS6510.mode.absx],							// 0x1e
	[jsSID.MOS6510.inst.slo, jsSID.MOS6510.mode.absx],							// 0x1f illegal fixed
	...
	[jsSID.MOS6510.inst.sre, jsSID.MOS6510.mode.indx],							// 0x43 illegal fixed
	...
	[jsSID.MOS6510.inst.sre, jsSID.MOS6510.mode.zp],							// 0x47 illegal fixed
	...
	[jsSID.MOS6510.inst.alr, jsSID.MOS6510.mode.imm],							// 0x4b
	...
	[jsSID.MOS6510.inst.sre, jsSID.MOS6510.mode.abs],							// 0x4f illegal fixed
	...
	[jsSID.MOS6510.inst.sre, jsSID.MOS6510.mode.indy],							// 0x53 illegal fixed
	...
	[jsSID.MOS6510.inst.sre, jsSID.MOS6510.mode.zpx],							// 0x57 illegal fixed
	...
	[jsSID.MOS6510.inst.sre, jsSID.MOS6510.mode.absy],							// 0x5b illegal fixed
	...
	[jsSID.MOS6510.inst.sre, jsSID.MOS6510.mode.absx],							// 0x5f illegal fixed
	...
	[jsSID.MOS6510.inst.tas, jsSID.MOS6510.mode.absy],							// 0x9b illegal fixed
	[jsSID.MOS6510.inst.xxx, jsSID.MOS6510.mode.xxx],							// 0x9c
	[jsSID.MOS6510.inst.sta, jsSID.MOS6510.mode.absx],							// 0x9d
	[jsSID.MOS6510.inst.shx, jsSID.MOS6510.mode.absx],							// 0x9e
	...
	[jsSID.MOS6510.inst.lax, jsSID.MOS6510.mode.indx],							// 0xa3 illegal fixed
	...
	[jsSID.MOS6510.inst.lax, jsSID.MOS6510.mode.zp],							// 0xa7 illegal fixed
	...
	[jsSID.MOS6510.inst.lax, jsSID.MOS6510.mode.imm],							// 0xab
	...
	[jsSID.MOS6510.inst.lax, jsSID.MOS6510.mode.abs],							// 0xaf //illegal fixed
	...
	[jsSID.MOS6510.inst.lax, jsSID.MOS6510.mode.indy],							// 0xb3 illegal fixed
	...
	[jsSID.MOS6510.inst.lax, jsSID.MOS6510.mode.zpy],							// 0xb7 illegal fixed
	...
	[jsSID.MOS6510.inst.lax, jsSID.MOS6510.mode.absy],							// 0xbf illegal fixed
